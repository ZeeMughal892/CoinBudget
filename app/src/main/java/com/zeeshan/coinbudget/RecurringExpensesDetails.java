...
public class RecurringExpensesDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialogBudget = new Dialog(RecurringExpensesDetails.this);
        ...
        dialogIncome = new Dialog(RecurringExpensesDetails.this);
        ...
        dialogExpenses = new Dialog(RecurringExpensesDetails.this);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.bank:
                        ...
                        datePickerDialog = new DatePickerDialog(RecurringExpensesDetails.this);
                        ...
                        break;
                    case R.id.budget:
                        startActivity(new Intent(RecurringExpensesDetails.this, Budget.class));
                        break;
                    case R.id.income:
                        ...
                        btnIncomeDetails.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                startActivity(new Intent(RecurringExpensesDetails.this, IncomeDetails.class));
                            }
                        });
                    ...
                    case R.id.expenses:
                        ...
                        btnRecurringExpense.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                startActivity(new Intent(RecurringExpensesDetails.this, com.zeeshan.coinbudget.RecurringExpenses.class));
                        ...
                        btnEstimatedExpense.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                startActivity(new Intent(RecurringExpensesDetails.this, EstimatedExpenses.class));
                                dialogExpenses.dismiss();
                            }
                        });
                        dialogExpenses.show();
                    ...
                    case R.id.savings:
                        ...
                        btnSavingDetails.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                startActivity(new Intent(RecurringExpensesDetails.this, SavingDetails.class));
                            }
                        });
